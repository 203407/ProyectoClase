...
from django.contrib.auth.models import User
from .serializers import RegisterSerializer,RegisterSerializer2
...
"""  def put(self,request,pk,format=None):
        ...
        if idResponse != 404:       
            ...
            if idResponseP != 404:
                serializerP = ProfileSerializerRegister(idResponseP,data=request.data, context={"request":request})
            else:
